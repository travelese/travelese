...
export type Database = {
  public: {
    Tables: {
      ...
      travel_entries: {
        Row: {
          ...
          stop: string | null
          team_id: string | null
          booking_members: Record<string, unknown> | null
        }
        Insert: {
          assigned_id?: string | null
          billed?: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "travel_entries_assigned_id_fkey"
            columns: ["assigned_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "travel_entries_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "travel_entries_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
      ...
      travel_booking_tags: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "booking_tags_travel_booking_id_fkey"
          ...
          {
            foreignKeyName: "travel_booking_tags_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
      ...
      travel_bookings: {
        Row: {
          ...
          team_id: string | null
          get_assigned_users_for_booking: Json | null
          get_booking_total_amount: number | null
          booking_members: Record<string, unknown> | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "travel_bookings_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
      ...
      travel_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "public_travel_reports_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "public_travel_reports_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
            referencedRelation: "travel_bookings"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "travel_reports_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teams"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_assigned_users_for_booking: {
        Args: {
          "": unknown
        }
        Returns: Json
    ...
    Enums: {
      ...
      travelStatus: "in_progress" | "completed"
