...
export type Database = {
  public: {
    Tables: {
      ...
      transactions: {
        Row: {
          ...
          base_currency: string | null
          category:
            | Database["public"]["Enums"]["transaction_category_type"]
            | null
          category_slug: string | null
          created_at: string
          currency: string
          ...
          internal_id: string
          manual: boolean | null
          method: Database["public"]["Enums"]["transaction_methods"]
          name: string
          note: string | null
    ...
    Functions: {
      ...
      calculate_transaction_differences: {
        Args: {
          p_team_id: string
        }
        Returns: {
    ...
    Enums: {
      ...
      property_type: "hotel" | "apartment" | "resort" | "villa"
      report_types: "profit" | "revenue" | "burn_rate" | "expense" | "bookings"
      team_roles: "owner" | "member"
      tracker_status: "in_progress" | "completed"
      ...
      transaction_methods:
        ...
        | "other"
        | "unknown"
      transaction_status: "posted" | "pending" | "excluded" | "completed"
      travel_providers: "duffel" | "amadeus" | "travelport" | "direct"
