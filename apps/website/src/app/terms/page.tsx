      ...
      <div className="max-w-[600px] m-auto my-20">
        ...
        <div className="text-component line-height-lg v-space-md">
          ...
          <p className="leading-7 mt-8">
            ...
            your relationship with Travelese.ai application (the "Service")
            operated by Armin Babaei Studio Inc. ("us", "we", or "our").
          </p>

          <p className="leading-7 mt-8">
            Please read these Terms and Conditions carefully before using our
            Travelese application (the "Service").
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            cancel it or Armin Babaei Studio Inc cancels it. You may cancel your
            Subscription renewal either through your online account management
            page or by contacting Armin Babaei Studio Inc customer support team.
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            you automatically authorize Armin Babaei Studio Inc to charge all
            Subscription fees incurred through your account to any such payment
            instruments.
          </p>

          <p className="leading-7 mt-8">
            Should automatic billing fail to occur for any reason, Armin Babaei
            Studio Inc will issue an electronic invoice indicating that you must
          ...
          <p className="leading-7 mt-8">
            Armin Babaei Studio Inc., in its sole discretion and at any time,
          ...
          <p className="leading-7 mt-8">
            Armin Babaei Studio Inc. will provide you with a reasonable prior
          ...
          <p className="leading-7 mt-8">
            Certain refund requests for Subscriptions may be considered by Armin
            Babaei Studio Inc. on a case-by-case basis and granted in sole
            discretion of Armin Babaei Studio Inc.
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            "Copyright Infringement" of support@travelese.ai and include in your
          ...
          <p className="leading-7 mt-8">
            ...
            property of Armin Babaei Studio Inc and its licensors. The Service
            is protected by copyright, trademark, and other laws of both the
            Sweden and foreign countries. Our trademarks and trade dress may not
            be used in connection with any product or service without the prior
            written consent of Armin Babaei Studio Inc.
          </p>
          ...
          <p className="leading-7 mt-8">
            ...
            that are not owned or controlled by Armin Babaei Studio Inc.
          </p>

          <p className="leading-7 mt-8">
            Armin Babaei Studio Inc has no control over, and assumes no
            responsibility for, the content, privacy policies, or practices of
            any third party web sites or services. You further acknowledge and
            agree that Acre Labs Ab shall not be responsible or liable, directly
          ...
          <p className="leading-7 mt-8">
            In no event shall Armin Babaei Studio Inc, nor its directors,
          ...
          <p className="leading-7 mt-8">
            Armin Babaei Studio Inc its subsidiaries, affiliates, and its
