...
const StaysCard: React.FC<StaysCardProps> = ({ stay, onSelect }) => {
...
const StaysSummary: React.FC<{ stay: StaysSearchResult; nights: number }> =
...
StaysSummary.displayName = "StaySummary";
...
const StaysDetails: React.FC<{ stay: StaysSearchResult; nights: number }> = ({
  stay,
  nights,
}) => (
...
const StaysDates: React.FC<{ stay: StaysSearchResult; nights: number }> = ({
  stay,
  nights,
}) => (
...
StaysCard.displayName = "StaysCard";
