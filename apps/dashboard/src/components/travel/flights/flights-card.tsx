  ...
  return (
    <Drawer>
      ...
      <DrawerContent className="w-full max-w-full">
        <DrawerHeader>
          <DrawerTitle>Flights Details</DrawerTitle>
          <DrawerDescription>
