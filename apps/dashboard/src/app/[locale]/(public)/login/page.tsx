        ...
        <div className="relative z-20 m-auto flex w-full max-w-[380px] flex-col py-8">
          <div className="flex w-full flex-col relative">
            ...
            <p className="text-xs text-[#878787]">
              ...
              to Travelese's{" "}
              <a href="https://travelese.ai/terms" className="underline">
                Terms of Service
              </a>{" "}
              and{" "}
              <a href="https://travelese.ai/policy" className="underline">
                Privacy Policy
              </a>
              .
            </p>
